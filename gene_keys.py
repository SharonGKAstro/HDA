...
List of each gate's associated gene key.
"""
...
GENE_KEYS = {
    ...
    55: {'Shadow': 'Victimization', 'Gift': 'Freedom', 'Siddhi': 'Freedom (Double Siddhi)'},
...
GK_LINES = {
    "lifework": {1: "Creator",
                 ...
                 5: "Fixer",
                 6: "Teacher"},
    "evolution": {1: "Self and Empowerment",
                  2: "Passion and Relationship",
                  3: "Energy and Experience",
                  4: "Love and Community",
                  5: "Power and Projection",
                  6: "Education and Surrender"},
    "radiance": {1: "Solitude",
                 2: "Marriage",
                 3: "Interaction",
                 4: "Friendship",
                 5: "Impact",
                 6: "Nurture"},
    "purpose": {1: "Physicality (Bones)",
                2: "Fluidity (Posture)",
                3: "Movement (Blood)",
                4: "Breath (Rhythm)",
                5: "Voice (Frequency)",
                6: "Intent (Cells)"},
    "vocation": {1: "Production (Originality)",
                 2: "Marketing (Value)",
                 3: "Strategy (Implementation)",
                 4: "Sales (Connection)",
                 5: "Management (Responsibility)",
                 6: "Philanthropy (Ethics)"},
    "culture": {1: "Individual",
                2: "Partnership",
                3: "Unit",
                4: "Network",
                5: "Empire/Society",
                6: "System"},
    "pearl": {1: "Simplicity",
              2: "Control/Recognition",
              3: "Celebrity/Celebration",
              4: "Charity",
              5: "Power",
              6: "Nature"},
    "attraction": {1: "Sterility/Fertility",
                   2: "Lust/Passion",
                   3: "Promiscuity/Playfulness",
                   4: "Frigidity/Romance",
                   5: "Entrapment/Sensuality",
                   6: "Disappointment/Innocence"},
    "iq": {1: "The Comtemplative Mind",
           2: "The Brilliant Mind",
           3: "The Flexible Mind",
           4: "The Influential Mind",
           5: "The Practical Mind",
           6: "The Objective Mind"},
    "eq": {1: "Self-esteem/Self-sabotage",
           2: "Courtesy/Aggression",
           3: "Sympathy/Apathy",
           4: "Kindness/Meanness",
           5: "Respect/Disrespect",
           6: "Reverence/Alienation"},
    "sq": {1: "Certainty",
           2: "Freedom",
           3: "Pleasure",
           4: "Belonging",
